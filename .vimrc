...
set cursorline	" Linje strek
set number	" Linje nummer
set showcmd	" vis kommando
set hlsearch	" higlight søk
set incsearch	" insta søk
set showmatch	" higlight []
set wildmenu	" cmd SENS
set mouse=a	" mus!!!
set smartcase 	" søk
set ignorecase 	" søk
set updatetime=1000
...
set laststatus=2 " statuslinje
set t_Co=256	 " tving farger
